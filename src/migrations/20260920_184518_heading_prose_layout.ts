...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   ALTER TYPE "public"."enum_pages_transition_layout" ADD VALUE 'prose';
  ALTER TYPE "public"."enum___pages_v_transition_v_layout" ADD VALUE 'prose';
  ALTER TYPE "public"."enum_posts_transition_layout" ADD VALUE 'prose';
  ALTER TYPE "public"."enum___posts_v_transition_v_layout" ADD VALUE 'prose';
  ALTER TYPE "public"."enum_wp_transition_layout" ADD VALUE 'prose';
  ALTER TYPE "public"."enum__wp_transition_v_layout" ADD VALUE 'prose';
  ALTER TYPE "public"."enum_lab_pages_transition_layout" ADD VALUE 'prose';
  ALTER TYPE "public"."enum___lab_pages_v_transition_v_layout" ADD VALUE 'prose';
  ALTER TYPE "public"."enum_expertise_pages_transition_layout" ADD VALUE 'prose';
  ALTER TYPE "public"."enum___expertise_pages_v_transition_v_layout" ADD VALUE 'prose';
  ALTER TYPE "public"."enum_audience_pages_transition_layout" ADD VALUE 'prose';
  ALTER TYPE "public"."enum___audience_pages_v_transition_v_layout" ADD VALUE 'prose';`)
}
