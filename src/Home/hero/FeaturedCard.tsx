...
export const FeaturedCard: React.FC<FeaturedCardProps> = ({ label = 'Insights', post }) => {
  ...
  return (
    ...
    >
      ...
      {image && (
        <div className="relative h-24 w-[97px] shrink-0 overflow-clip rounded-md">
