 ...
 */
const GUIDE_NOT_LIMIT = `Never tell the visitor what this chat can't do, and never apologize for it: never write "can't", "cannot", or "unable" about this chat. Guide them to the next step instead.`
