...
const SECTIONS: DemoShellSection[] = [
  ...
  },
  {
    ...
    icon: IconLineDashed,
    paste: {
      file: 'src/features/immersive/visual/looks.ts',
      symbol: 'STREAK_LOOKS',
      format: 'code',
      note: 'A delta-only preset plus its look entry, named in the Ship as look folder. Once both are in, the look appears in the Look picker of every Streak Field visual slot: opening heroes, index pages, menu previews and media blocks. Ground and seed stay out: the page band sets the surface and the CMS assigns each entry its seed.',
      steps: [
