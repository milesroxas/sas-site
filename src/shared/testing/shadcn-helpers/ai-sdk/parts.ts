...
export function replaceOrPushPart<DATA_PARTS extends UIDataTypes, TOOLS extends UITools>(
  ...
  if ('id' in part && part.id) {
    const index = parts.findIndex(
      (currentPart) =>
        currentPart.type === part.type && 'id' in currentPart && currentPart.id === part.id,
    )
...
function findToolPartIndex<DATA_PARTS extends UIDataTypes, TOOLS extends UITools>(
  parts: Array<UIMessagePart<DATA_PARTS, TOOLS>>,
  toolCallId: string,
) {
...
export function materializeParts<DATA_PARTS extends UIDataTypes, TOOLS extends UITools>(
...
export function eventsFromParts<DATA_PARTS extends UIDataTypes, TOOLS extends UITools>(
  parts: Array<UIMessagePart<DATA_PARTS, TOOLS>>,
