...
export function* yieldMessageParts<
  ...
  DATA_PARTS extends UIDataTypes = UIDataTypes,
  TOOLS extends UITools = UITools,
>(message: UIMessage<METADATA, DATA_PARTS, TOOLS>, options: YieldMessagePartsOptions = {}) {
...
export async function* streamMessageParts<
  ...
  DATA_PARTS extends UIDataTypes = UIDataTypes,
  TOOLS extends UITools = UITools,
>(message: UIMessage<METADATA, DATA_PARTS, TOOLS>, options: StreamMessagePartsOptions = {}) {
