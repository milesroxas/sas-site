...
export type ToolWriterOptions<TOOLS extends ToolSet, NAME extends keyof TOOLS> = {
  toolCallId?: string
  title?: string
 ...
 */
export type ChatEvent<DATA extends DataTypes = DataTypes, TOOLS extends ToolSet = ToolSet> =
...
export type TransportContext<
  ...
  TOOLS extends ToolSet = ToolSet,
> = {
  resolveTurn(messages: MESSAGE[], messageId?: string): ChatTurn<MESSAGE, DATA, TOOLS> | undefined
  streamTurn(
