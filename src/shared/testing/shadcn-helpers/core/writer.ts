...
import { cloneValue, DEFAULT_REASONING, DEFAULT_TEXT, getDataPartName } from './utils'
 ...
 */
export function createEventWriter<DATA extends DataTypes, TOOLS extends ToolSet>(
  ...
  const writer: EventWriter<DATA, TOOLS> = {
    ...
    tool<NAME extends keyof TOOLS & string>(
      ...
      const toolCallId = clonedOptions.toolCallId ?? context.ids.nextToolCallId()
