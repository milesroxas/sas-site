...
- **Make Story Beats retrieval-sized.** In Case Study Content and Lab Projects, a beat should carry
  one self-contained idea with an honest heading. Work and Lab Pages render these server-side, and the Ask
